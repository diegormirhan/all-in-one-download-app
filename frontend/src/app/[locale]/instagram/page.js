...
export default function Instagram() {
    ...
    return (
        ...
        <section className="w-full flex justify-between mb-4">
          ...
          <div className="p-4 w-full max-w-3xl text-center">
            ...
            <div className="my-10 text-sm w-full mx-auto text-left font-semibold md:text-center md:w-4/5 md:font-medium">
              <p className="mb-4">Best Video Downloader gives you the tool to download any <strong>video</strong>, <strong>image</strong> or <strong>music</strong> from most of the social media platforms that exists today. </p>
        ...
        <section>
          <CarouselCards />
          <ImportantTips mediaType="Media" socialMedia="social media"/>

          <div className="flex flex-col space-y-10 lg:flex-row lg:space-x-10 lg:space-y-0 items-start w-11/12 md:w-4/5 m-auto mb-14">
            <FAQAccordion socialMedia="Social Media" mediaType="media" mediaTypes="medias"/>
            <HowToUse socialMedia="Social Media" mediaType="media" mediaTypes="medias"/>
          </div>
