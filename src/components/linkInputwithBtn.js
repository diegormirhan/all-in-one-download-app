  ...
  return (
    <>
      <div className="relative mb-8 w-11/12 md:w-2/3 mx-auto">
        <input type="text" id="input link" name="input link" placeholder={tDefault('introduction-input')} value={link} onChange={(e) => setLink(e.target.value)} onKeyDown={handleKeyDown} className={`w-full p-3 pl-6 pr-12 border-0 rounded-lg drop-shadow-lg focus:outline-none focus:ring-2 ${inputClasses} ease-in-out transition-all duration-100`}></input>
